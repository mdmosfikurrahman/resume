...
% Experience
    ...
    \resumeItemListStart
    \resumeItem{Leading the backend development of Akij Air, including system architecture, service design, and team coordination.}
    \resumeItem{Developed scalable APIs and core modules using .NET Core and PostgreSQL.}
    \resumeItem{Previously led the TrackForce team; built REST APIs and SQL Stored Procedures for reporting.}
    \resumeItemListEnd
