...
\resumeItem{Migrated .NET modules to Java, improving scalability and modularity.}
...
\resumeSubheading
{Daffodil International University}{Dhaka, Bangladesh}
{Adjunct Lecturer, Dept. of Computer Science}{https://daffodilvarsity.edu.bd/}{Jun. 2021 -- Apr. 2022}
\resumeItemListStart
\resumeItem{Taught undergraduate courses on OOP and Data Structures.}
\resumeItem{Designed assignments and assisted in lab-based instruction.}
\resumeItem{Mentored students on academic and research activities.}
\resumeItemListEnd
\resumeSubHeadingListEnd
...
\item{
      ...
      \textbf{Frameworks \& Tools:} Spring Boot, .NET Core, Camunda, Thymeleaf, Docker \\
