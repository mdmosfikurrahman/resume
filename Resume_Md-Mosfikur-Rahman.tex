...
\resumeItemListStart
\resumeItem{Rebuilt system in Java microservices, replacing .NET stack.}
...
\resumeItemListStart
\resumeItem{Built APIs and reports in Java, optimizing delivery flow.}
...
\item{
      ...
      \textbf{Frameworks \& Tools:} Spring Boot, React, Angular, Thymeleaf, Docker \\
