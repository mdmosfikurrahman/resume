...
\begin{document}
    ...
    \resumeItemListStart
        \resumeItem{Lead backend development using Camunda BPMN/DMN for process automation and low-code solutions.}
        \resumeItem{Architect scalable Java applications with advanced design patterns and optimize Oracle, MySQL and MSSQL performance.}
        \resumeItem{Integrate new tools, libraries, and frameworks to enhance system performance and efficiency.}
    \resumeItemListEnd
    \resumeSubheading
    ...
    \resumeSubHeadingListStart
    \item{
        \textbf{Core Skills:} Microservices, Process Automation, Backend Integration \\
        \textbf{Programming Languages:} Java, JavaScript, Python \\
        \textbf{Frameworks:} Spring Boot, Spring Batch \\
        \textbf{Databases:} Oracle, MySQL, MSSQL, MongoDB \\
        \textbf{Technical Tools:} Git, DataGrip, JIRA
    }
    \resumeSubHeadingListEnd
