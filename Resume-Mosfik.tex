...
\begin{document}
    ...
    \resumeSubHeadingListStart
    \item{
        \textbf{Core Skills:} OOP, REST API, SOAP, Micro-services, Data Structures, UML, Code Review \\
        \textbf{Programming Languages:} Java, JavaScript, Python \\
        \textbf{Frameworks:} Spring Boot, Spring Batch, Bootstrap, Thymeleaf, React JS \\
        \textbf{Technical Tools:} Git, Postman, IntelliJ IDEA, DataGrip \\
        \textbf{Database Expertise:} Oracle, MySQL, MongoDB, Spiral DB
    }
    \resumeSubHeadingListEnd
